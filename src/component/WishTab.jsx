...
const WishTab = ({ book }) => {
  ...
  return (
    <div className="h-72 w-full border border-[#13131326] rounded-2xl mt-8 p-6 flex gap-6">
      ...
      <div className="flex-1">
        ...
        <div className="mt-4 space-x-5">
          <button className="btn bg-[#328EFF26] hover:bg-[#328EFF26] text-[#328EFF] rounded-[30px] px-8">
            Category: Classic
          </button>
          <button className="btn bg-[#FFAC3326] hover:bg-[#FFAC3326] text-[#FFAC33] rounded-[30px] px-8">
            Rating: {rating}
          </button>
          <button className="btn bg-[#23BE0A] hover:bg-[#23BE0A] text-white rounded-[30px]  px-8">
            View Details
          </button>
        </div>
      </div>
